...
// on-chain Web2Json oracle) it overrides the static table, changing the risk score accordingly.
...
// TestProvenanceCanonical pins the serialization the enclave and source API must agree on.
